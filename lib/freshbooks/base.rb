...
module FreshBooks
  class Base
    ...
    def self.establish_connection(account_url, consumer_key, consumer_secret, token, token_secret, request_headers = {})
      @@connection = Connection.new(account_url, consumer_key, consumer_secret, token, token_secret, request_headers)
    end
